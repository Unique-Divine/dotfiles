---
editUrl: https://github.com/herdrdev/herdr/blob/master/docs/versions/0.5.12/website/src/content/docs/index.mdx
...
hero:
  ...
  actions:
    - text: Install Herdr
      link: /docs/0.5.12/install/
    - text: Quick start
      link: /docs/0.5.12/quick-start/
      variant: secondary
---
