---
editUrl: https://github.com/herdrdev/herdr/blob/master/docs/versions/0.6.1/website/src/content/docs/quick-start.mdx
title: Quick start
...
For the local, SSH, and `herdr --remote` workflows, see [How to work with Herdr](/docs/0.6.1/how-to-work/).
...
For repeat targets, put the host in your SSH config. See [How to work with Herdr](/docs/0.6.1/how-to-work/) for the full model.
