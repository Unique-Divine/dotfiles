---
editUrl: https://github.com/herdrdev/herdr/blob/master/docs/versions/0.6.3/website/src/content/docs/index.mdx
...
hero:
  ...
  actions:
    - text: Install Herdr
      link: /docs/0.6.3/install/
    - text: Quick start
      link: /docs/0.6.3/quick-start/
      variant: secondary
---
