---
editUrl: https://github.com/herdrdev/herdr/blob/master/docs/versions/0.6.7/website/src/content/docs/quick-start.mdx
title: Quick start
...
For repeat targets, put the host in your SSH config. See [How to work with Herdr](/docs/0.6.7/how-to-work/) for the full model.
