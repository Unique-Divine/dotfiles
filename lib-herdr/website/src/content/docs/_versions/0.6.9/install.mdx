---
editUrl: https://github.com/herdrdev/herdr/blob/master/docs/versions/0.6.9/website/src/content/docs/install.mdx
title: Install Herdr
...
Stable Herdr releases support Linux and macOS. Native Windows builds are preview-only beta releases; see [Windows beta](/docs/0.6.9/windows-beta/) for supported workflows and known limitations.
