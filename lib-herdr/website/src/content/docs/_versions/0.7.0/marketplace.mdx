---
editUrl: https://github.com/herdrdev/herdr/blob/master/docs/versions/0.7.0/website/src/content/docs/marketplace.mdx
title: Marketplace
...
[Plugins](/docs/0.7.0/plugins/) for the manifest and authoring reference.
