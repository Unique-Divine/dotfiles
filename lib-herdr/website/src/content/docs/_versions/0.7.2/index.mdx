---
editUrl: https://github.com/herdrdev/herdr/blob/master/docs/versions/0.7.2/website/src/content/docs/index.mdx
...
hero:
  ...
  actions:
    - text: Install Herdr
      link: /docs/0.7.2/install/
    - text: Quick start
      link: /docs/0.7.2/quick-start/
      variant: secondary
---
...
<CardGrid>
  <Card title="New to terminal multiplexers?">
    ...
    [Quick start →](/docs/0.7.2/quick-start/)
  </Card>
  <Card title="Coming from tmux or zellij?">
    ...
    [Concepts →](/docs/0.7.2/concepts/) · [Keybindings →](/docs/0.7.2/configuration/#keybindings)
  </Card>
</CardGrid>
