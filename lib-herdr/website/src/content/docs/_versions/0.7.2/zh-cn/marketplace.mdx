---
editUrl: https://github.com/herdrdev/herdr/blob/master/docs/versions/0.7.2/website/src/content/docs/zh-cn/marketplace.mdx
title: 插件市场
...
审查过它,所以在安装任何插件之前,请先阅读[信任指南](/zh-cn/docs/0.7.2/plugins/#信任与安全)。
...
清单,这条命令就能用了。清单和编写参考见[插件](/zh-cn/docs/0.7.2/plugins/)。
