---
editUrl: https://github.com/herdrdev/herdr/blob/master/docs/versions/0.7.2/website/src/content/docs/zh-cn/plugins.mdx
title: 插件
...
[CLI 参考](/zh-cn/docs/0.7.2/cli-reference/)中的每条命令插件都能用,你自己能以
...
[socket API](/zh-cn/docs/0.7.2/socket-api/)。
...
命令见 [CLI 参考](/zh-cn/docs/0.7.2/cli-reference/),原始请求结构见
[socket API](/zh-cn/docs/0.7.2/socket-api/)。
...
每 30 分钟刷新一次。发现机制的工作方式见[插件市场](/zh-cn/docs/0.7.2/marketplace/)。
