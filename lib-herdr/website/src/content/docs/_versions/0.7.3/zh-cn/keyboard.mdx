---
editUrl: https://github.com/herdrdev/herdr/blob/master/docs/versions/0.7.3/website/src/content/docs/zh-cn/keyboard.mdx
title: 键盘
description: 前缀键是什么、应该先学哪些绑定,以及如何做到不用前缀键。
---

:::tip[从 tmux 或 zellij 迁移过来?]
这套模型你已经很熟悉了。直接跳到[按键绑定参考](/zh-cn/docs/0.7.3/configuration/#按键绑定)查看完整的默认键位和配置语法。
:::
...
完整键位和绑定语法见[按键绑定参考](/zh-cn/docs/0.7.3/configuration/#按键绑定)。
