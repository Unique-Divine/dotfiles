---
editUrl: https://github.com/herdrdev/herdr/blob/master/docs/versions/0.7.5/website/src/content/docs/agent-skill.mdx
title: Agent skill file
description: Install Herdr instructions for Claude Code or another coding agent.
---

Herdr ships a reusable agent skill file at [`SKILL.md`](https://github.com/herdrdev/herdr/blob/v0.7.5/SKILL.md).
...
```text
https://github.com/herdrdev/herdr/blob/v0.7.5/SKILL.md
```
...
[Open `SKILL.md` on GitHub →](https://github.com/herdrdev/herdr/blob/v0.7.5/SKILL.md)
