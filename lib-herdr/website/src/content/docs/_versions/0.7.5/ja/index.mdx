---
editUrl: https://github.com/herdrdev/herdr/blob/master/docs/versions/0.7.5/website/src/content/docs/ja/index.mdx
title: Herdr ドキュメント
...
hero:
  ...
  actions:
    - text: Herdr をインストール
      link: /ja/docs/0.7.5/install/
    - text: クイックスタート
      link: /ja/docs/0.7.5/quick-start/
      variant: secondary
---
...
<CardGrid>
  <Card title="ターミナルマルチプレクサは初めて?">
    ...
    [クイックスタート →](/ja/docs/0.7.5/quick-start/)
  </Card>
  <Card title="tmux や zellij から乗り換え?">
    モデルはすでにご存じのとおりです。プレフィックスは `ctrl+b`、ペインは永続化され、デタッチと再アタッチは期待どおりに動作します。

    [コンセプト →](/ja/docs/0.7.5/concepts/) · [キーバインド →](/ja/docs/0.7.5/configuration/#キーバインド)
  </Card>
</CardGrid>
