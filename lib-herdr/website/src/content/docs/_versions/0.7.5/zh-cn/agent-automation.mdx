---
editUrl: https://github.com/herdrdev/herdr/blob/master/docs/versions/0.7.5/website/src/content/docs/zh-cn/agent-automation.mdx
title: 智能体自动化
...
完整命令和选项列表见 [CLI 参考](/zh-cn/docs/0.7.5/cli-reference/)。Shell 补全也能以交互方式显示同一命令树。
