---
editUrl: https://github.com/herdrdev/herdr/blob/master/docs/versions/0.7.5/website/src/content/docs/zh-cn/agent-skill.mdx
title: 智能体技能文件
description: 为 Claude Code 或其他编程智能体安装 Herdr 使用说明。
---

Herdr 提供了一个可复用的智能体技能文件: [`SKILL.md`](https://github.com/herdrdev/herdr/blob/v0.7.5/SKILL.md)。
...
[在 GitHub 上打开 `SKILL.md` →](https://github.com/herdrdev/herdr/blob/v0.7.5/SKILL.md)
