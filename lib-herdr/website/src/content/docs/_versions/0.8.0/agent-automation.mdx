---
editUrl: https://github.com/herdrdev/herdr/blob/master/docs/versions/0.8.0/website/src/content/docs/agent-automation.mdx
...
See the [CLI reference](/docs/0.8.0/cli-reference/) for the complete command and option list. Shell completions expose the same command tree interactively.
