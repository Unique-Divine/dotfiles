---
editUrl: https://github.com/herdrdev/herdr/blob/master/docs/versions/0.8.0/website/src/content/docs/agent-skill.mdx
title: Agent skill file
description: Install Herdr instructions for Claude Code or another coding agent.
---

Herdr ships a reusable agent skill file at [`skills/herdr/SKILL.md`](https://github.com/herdrdev/herdr/blob/v0.8.0/skills/herdr/SKILL.md).
...
```text
https://github.com/herdrdev/herdr/blob/v0.8.0/skills/herdr/SKILL.md
```
...
[Open `SKILL.md` on GitHub →](https://github.com/herdrdev/herdr/blob/v0.8.0/skills/herdr/SKILL.md)
