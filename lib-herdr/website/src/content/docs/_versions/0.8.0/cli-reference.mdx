---
editUrl: https://github.com/herdrdev/herdr/blob/master/docs/versions/0.8.0/website/src/content/docs/cli-reference.mdx
title: CLI reference
...
For the pane-versus-agent model and complete orchestration examples, see [Agent automation](/docs/0.8.0/agent-automation/).
