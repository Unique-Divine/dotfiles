---
editUrl: https://github.com/herdrdev/herdr/blob/master/docs/versions/0.8.0/website/src/content/docs/ja/cli-reference.mdx
title: CLI リファレンス
...
ペインとエージェントの使い分けや一連の連携例は、[エージェント自動化](/ja/docs/0.8.0/agent-automation/) を参照してください。
