---
editUrl: https://github.com/herdrdev/herdr/blob/master/docs/next/website/src/content/docs/agent-automation.mdx
...
See the [CLI reference](/docs/preview/cli-reference/) for the complete command and option list. Shell completions expose the same command tree interactively.
