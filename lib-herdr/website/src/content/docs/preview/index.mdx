---
editUrl: https://github.com/herdrdev/herdr/blob/master/docs/next/website/src/content/docs/index.mdx
title: Herdr preview documentation
...
hero:
  ...
  actions:
    - text: Install Herdr
      link: /docs/preview/install/
    - text: Quick start
      link: /docs/preview/quick-start/
      variant: secondary
---
...
<CardGrid>
  <Card title="New to terminal multiplexers?">
    ...
    [Quick start →](/docs/preview/quick-start/)
  </Card>
  <Card title="Coming from tmux or zellij?">
    ...
    [Concepts →](/docs/preview/concepts/) · [Keybindings →](/docs/preview/configuration/#keybindings)
  </Card>
</CardGrid>
