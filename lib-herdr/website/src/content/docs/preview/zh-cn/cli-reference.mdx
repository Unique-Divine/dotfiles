---
editUrl: https://github.com/herdrdev/herdr/blob/master/docs/next/website/src/content/docs/zh-cn/cli-reference.mdx
title: CLI 参考
...
窗格与智能体的模型和完整协调示例见[智能体自动化](/zh-cn/docs/preview/agent-automation/)。
